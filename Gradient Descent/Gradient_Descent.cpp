...
int main()
{
    ...
    while(1){
	    ...
	    for(int i=0;i<train_Data_Size;++i){
	    	error_gradient_b_0+=(Y_train[i]-y_pred[i]);
	    	error_gradient_b_1+=(Y_train[i]-y_pred[i])*X_train[i];
	    }
	    error_gradient_b_0=(-2)*(error_gradient_b_0);
	    error_gradient_b_0=error_gradient_b_0/train_Data_Size;
	    error_gradient_b_1=(-2)*(error_gradient_b_1);
	    error_gradient_b_1=error_gradient_b_1/train_Data_Size;
